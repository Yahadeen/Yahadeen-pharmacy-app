/**
 * Password reset request. Presented as a modal from the login screen. Supabase
 * emails a recovery link; completing the reset happens in the browser, so this
 * screen's job ends at "we sent it".
 */
          ...
          {sent ? (
            ...
            <View style={styles.form}>
              <Text style={[TYPE.body, { color: colors.mutedText }]}>
                Enter the email address on your Yahadeen Pharm Go account and we will send you a link to set
                a new password.
              </Text>
