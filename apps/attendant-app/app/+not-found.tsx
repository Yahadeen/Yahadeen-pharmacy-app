...
export default function NotFound() {
  ...
  return (
    <View style={[styles.root, { backgroundColor: colors.background }]}>
      <Text style={[TYPE.title, styles.center, { color: colors.text }]}>That page has moved</Text>
      <Text style={[TYPE.body, styles.body, { color: colors.mutedText }]}>
        The link you followed does not point anywhere in yahadeen Staff. Head back to the queue and
        try again.
      </Text>
      <GlassButton
