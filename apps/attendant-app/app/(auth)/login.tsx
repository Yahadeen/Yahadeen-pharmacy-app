/**
 * Staff sign-in. Same shape as the customer screen minus the sign-up footer —
    ...
    <SafeAreaView style={[styles.safe, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        >
          <ScreenHeader
            title="Staff sign-in"
            subtitle="Open your counter for the day"
            onBack={() => router.back()}
          />
          ...
          <Text style={[TYPE.caption, styles.footer, { color: colors.faintText }]}>
            ...
            <Pressable onPress={() => router.push('/(auth)/signup' as any)}>
              <Text style={[TYPE.caption, { color: colors.primary }]}>Create account</Text>
            </Pressable>
          </Text>
        </ScrollView>
      </KeyboardAvoidingView>
