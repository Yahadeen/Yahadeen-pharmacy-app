...
export const demoNotifications: AppNotification[] = [
  {
    ...
    body: 'PG-7A31C8 from Ada Okafor — 3 items, paid.',
  ...
  },
  {
    ...
    body: 'PG-6B2D07 includes Amoxicillin 500mg. A pharmacist must approve the upload.',
  ...
  },
  {
    ...
    user_id: demoStaff.id,
    title: 'Out of stock',
    body: 'Ventolin Inhaler 100mcg hit zero. 3 customers are waiting on a restock alert.',
  ...
  },
  {
    ...
    body: 'Chidi N. collected PG-1A08F6 and is on the way to Lekki Phase 1.',
